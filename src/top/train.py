...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", default=100, type=int, help="number of traning epochs")
    ...
    if args.tiny:
        ...
        xnet = HourglassNet(num_classes=4, num_stacks=args.num_stack, num_channels=128, inres=(256, 256),
                            outres=(64, 64))
