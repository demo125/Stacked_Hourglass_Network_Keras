...
class MPIIDataGen(object):
    ...
    def generator(self, batch_size, num_hgstack, sigma_scale=0.04, with_meta=False, is_shuffle=False,
    ...
    def process_image(self, sample_index, kpanno, sigma_scale, rot_flag, scale_flag, flip_flag):
        ...
        # scale
        # if scale_flag:
        #     scale = scale * np.random.uniform(0.95, 1.25)

        # # rotate image
        # if rot_flag:
        #     rot = np.random.randint(-1 * 35, 35)
        # else:
        #     rot = 0
        rot = 0
